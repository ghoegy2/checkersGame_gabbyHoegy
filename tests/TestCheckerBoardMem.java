...
/**
 * TestCheckerBoardMem contains test case functions to test some of the pivotal functions contained in the
 * CheckerBoardMem class. The functions it tests include CheckerBoardMem(int), whatsAtPos(BoardPosition),
 * placePiece(BoardPosition, char), getPieceCounts(void), getViableDirections(void), getRowNum(void), getColNum(void),
 * checkPlayerWin(Character), crownPiece(BoardPosition), movePiece(BoardPosition, DirectionEnum),
 * jumpPiece(BoardPosition, DirectionEnum), scanSurroundingPositions(BoardPosition), and getDirection(DirectionEnum).
 * TestCheckerBoardMem contains a function that makes accessing the CheckerBoardMem constructor easier, and a functions
 * that turns the board array into a String.
 *
...
public class TestCheckerBoardMem {
    ...
    // CheckerBoardMem(int) test #1 - boundary test - 8 is the minimum board size dimension that can be input
    @Test
    public void testCheckerBoardMem_Integer_8() {
        char[][] expected = {
                {' ', '*', ' ', '*', ' ', '*', ' ', '*'},
                {'*', ' ', '*', ' ', '*', ' ', '*', ' '},
                {' ', '*', ' ', '*', ' ', '*', ' ', '*'},
    ...
    // CheckerBoardMem(int) test #2 - boundary test - 16 is the maximum board size dimension that can be input
    @Test
    public void testCheckerBoardMem_Integer_16() {
        char[][] expected = {
                {' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*'},
                {'*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' '},
                {' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*'},
    ...
    // CheckerBoardMem(int) test #3 - routine test - 12 is a common board size dimension that can be input
    @Test
    public void testCheckerBoardMem_Integer_12() {
        char[][] expected = {
                {' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*'},
                {'*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' '},
                {' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*', ' ', '*'},
    ...
    // placePiece(BoardPosition, char) test #2 - boundary test - (1,7) is an upper right position of the board when board size is 8
    @Test
    public void testPlacePiece_BoardPosition_1_7_char_x() {
        ICheckerBoard board = makeBoard(8);
        board.setPlayerOne('x');
        BoardPosition pos = new BoardPosition(1, 7);
        char[][] expected = {
                {' ', '*', ' ', '*', ' ', '*', ' ', '*'},
                {'*', ' ', '*', ' ', '*', ' ', '*', 'x'},
                {' ', '*', ' ', '*', ' ', '*', ' ', '*'},
    ...
    // placePiece(BoardPosition, char) test #3 - boundary test - (6,0) is a lower left position of the board when board size is 8
    @Test
    public void testPlacePiece_BoardPosition_6_0_char_o() {
        ICheckerBoard board = makeBoard(8);
